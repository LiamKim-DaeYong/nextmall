...
모듈형 쇼핑몰 백엔드 프로젝트입니다.
다양한 기술 스택을 직접 설계하고 구현하며, **실무 수준의 아키텍처 설계와 기술 역량 확장**을 목표로 합니다.
...
| Phase | 주제 | 상태     | 문서                                             |
|-------|------|--------|------------------------------------------------|
| 1 | 프로젝트 구조 + Docker | ✅ Done | [Phase 1 Tasks](./docs/tasks/phase-1-tasks.md) |
| 2 | 인증 시스템 + Redis | ✅ 진행중 | [Phase 2 Tasks](./docs/tasks/phase-2-tasks.md) |
| 3 | 상품/리뷰 + MongoDB | ⏳ 예정   |                                                |
| ... | ... | ...    | ...                                            |
