...
class SignUpController(
    ...
    @PostMapping("/local")
    fun local(@RequestBody request: LocalSignUpRequest): ResponseEntity<SignUpResponse> {
        val param =
            SignUpCommandParam(
        ...
        return ResponseEntity
            ...
            .body(SignUpResponse(result.userId, result.authAccountId))
    }

    @PostMapping("/social")
    fun social(@RequestBody request: SocialSignUpRequest): ResponseEntity<SignUpResponse> {
//        val providerAccountId = socialOAuthService.fetchProviderAccountId(
